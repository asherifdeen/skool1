...
$_SESSION['assessment_academicyear']=$academicyear;
$_SESSION['assessment_term']=$term;
$_SESSION['assessment_category']=$_POST['category'];
$_SESSION['assessment_class']=$_POST['class'];
$_SESSION['assessment_subject']=$_POST['subject'];
