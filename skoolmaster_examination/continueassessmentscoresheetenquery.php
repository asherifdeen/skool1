...
<html lang="en">
  <head>
    ...
    <title> Termly Assessment Score Sheet | SkoolMaster</title>
...
$(document).ready(function(){
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_check"></i> Termly Assessment Score Sheet Enquiry</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Assessment Score Sheet Enquiry</li>						  	
					</ol>
				</div>
			</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="continueassessmentscoresheetreport.php" enctype="multipart/form-data">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <select class="form-control input-sm" id="term" name="term"  required >
                                                    ...
                                                    <?php
													$sql=mysqli_query($con,"select distinct term from term");
