...
<html lang="en">
  <head>
    ...
    <title>Termly Exams Score Sheet Report | SkoolMaster</title>
...
.break{ page-break-after:always;}
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_documents_alt"></i>Termly Exams Score Sheet Report</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
 ...
 <tr>
                          ...
                          <tr>
                            <td align="center" style="font-family:Tahoma; font-size:18px; text-align:center; font-weight:bold;color:#000;">STUDENTS TERMLY EXAMS SCORE SHEET</td>
                          </tr>
                        ...
                        <table width="780" border="1" style="margin-top:30px;color:#000;" align="center">
                        	<tr>
                                ...
                                <td style="font-weight:bold" align="center">Exams Score</td>
                            </tr>
