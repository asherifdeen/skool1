...
<html lang="en">
  <head>
    ...
    <title> Assessment | SkoolMaster</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="assessmentscore.php" enctype="multipart/form-data">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <select class="form-control input-sm" id="category" name="category"  required >
                                              		...
                                              		<?php
													$sql=mysqli_query($con,"select distinct category from subjectassign where staffid='$staffid'");
													while($categoryassign=mysqli_fetch_array($sql)){
													?>
													<option value="<?php echo $categoryassign['category'] ?>"><?php echo $categoryassign['category'] ?></option>
													<?php 
													}
													?>
