  ...
  <section id="container" class="">
     ...
     <header class="header dark-bg">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_check"></i> Termly Average Score Enquiry</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Termly Average Enquiry</li>						  	
					</ol>
				</div>
			</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="termlyaveragereport.php" enctype="multipart/form-data">
