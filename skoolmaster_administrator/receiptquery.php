...
<html lang="en">
  <head>
    ...
    <title>Receipt Enqury | SkoolMaster</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-credit-card"></i> Receipt Enqury</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="fa fa-credit-card"></i>Receipt Enqury</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="paymentreciept.php" enctype="multipart/form-data">
                            <div class="row" style="margin-bottom:15px; margin-left:10px;"> 
 								<div class="form-group">
                                  <div class="col-lg-4">
                                      <button class="btn btn-primary btn-sm" type="submit"><span class="icon_folder"></span> Print</button>
                      ...
                      <section class="panel">
                          <header class="panel-heading tab-bg-primary ">
                              <ul class="nav nav-tabs">
                                  <li class="active">
                                      <a data-toggle="tab" href="#personal">Receipt Details</a>
                                  </li>
                          ...
                          <div class="panel-body">
                              <div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                      	<div class="col-lg-4 control-label">Receipt Number<span style="color:#F00;">*</span></div>
                                        <div class="col-lg-4">
                                              <input class="form-control input-sm" id="receiptnumber" name="receiptnumber"  type="text" value="" required>
                                          </div>
                                      </div>
