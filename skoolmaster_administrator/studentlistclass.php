                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="studentlistclassreport.php" enctype="multipart/form-data">
                          ...
                          <div class="panel-body">
                              <div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                      	<div class="col-lg-4 control-label">Select Class<span style="color:#F00;">*</span></div>
                                        <div class="col-lg-4">
