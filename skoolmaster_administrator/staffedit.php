...
<html lang="en">
  <head>
    ...
    <title>Staff Edit | SkoolMaster</title>
...
<script src="../resources/js/bootstrap.min.js"></script>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_document_alt"></i> Staff Edit</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Staff Edit</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="staffeditscript.php" enctype="multipart/form-data">
                              ...
                              <div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-3">
                                              <input class="form-control input-sm" id="lastname" name="lastname"  type="text" placeholder="Last Name" value="<?php echo $lastname;?>" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-3">
                                              <input class="form-control input-sm" id="firstname" name="firstname"  type="text" placeholder="First Name" value="<?php echo $firstname;?>" required />
                                          </div>
                                      </div>
