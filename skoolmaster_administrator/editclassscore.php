...
<html lang="en">
  <head>
    ...
    <title> Assessment Score Edit | SkoolMaster</title>
...
<script src="../resources/js/bootstrap.min.js"></script>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_check"></i> Assessment Score Edit</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Assessment Score Edit</li>						  	
					</ol>
				</div>
			</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="assessmentscoreupdatescript.php" enctype="multipart/form-data">
