...
<html lang="en">
  <head>
    ...
    <title> Graduate List Enquiry| SkoolMaster</title>
...
$(document).ready(function(){
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-graduation-cap"></i> Graduate List Enquiry</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="fa fa-graduation-cap"></i>Graduate List Enquiry</li>						  	
					</ol>
				</div>
			</div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            <section class="panel-heading">
                               Graduates List Enquiry
                            </section>
                            <div class="panel-body">
                            <form class="form-horizontal" method="post" action="graduatelistreport.php" enctype="multipart/form-data">
                            <div class="row" style="margin-bottom:15px; margin-left:10px;"> 
 								<div class="form-group">
                                  <div class="col-lg-6">
                                      <button class="btn btn-primary btn-sm" type="submit"><span class="icon_folder"></span> View Report</button>
                      ...
                      <section class="panel">
                          <header class="panel-heading tab-bg-primary ">
                              <ul class="nav nav-tabs">
                                  <li class="active">
                                      <a data-toggle="tab" href="#personal">Student Detials</a>
                                  </li>
                          ...
                          <div class="panel-body">
                              <div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                      	<div class="col-lg-4 control-label">Batch <span style="color:#F00;">*</span></div>
                                        <div class="col-lg-4">
                                              <select class="form-control input-sm" id="batch" name="batch"  required >
                                              
                                              		<option value="">Batch</option>
                                                    <?php
													$sql=mysqli_query($con,"select distinct batch from graduate");
													while($batch=mysqli_fetch_array($sql)){
													?>
