...
<html lang="en">
  <head>
    ...
    <title>Scholarship | SkoolMaster</title>
...
<script src="../resources/js/bootstrap.min.js"></script>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_profile"></i> Scholarship List</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_profile"></i>Scholarship List</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                         ...
                         <div class="panel">
                            ...
                            <div class="panel-body">
                            	...
                            	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $query=mysqli_query($con,"select * from register where scholarship='Yes'");
