		  ...
		  <div class="row">
              ...
              <!-- page start-->
                      ...
                      <table width="650" border="0" align="center" style="color:#000;">
                          ...
                          <tr>
                            <td align="center" style="font-family:Tahoma; font-size:18px; text-align:center; font-weight:bold;color:#000;">STUDENTS LIST BY <?php echo strtoupper($fee) ?> FOR <?php echo strtoupper($academicyear). " ". strtoupper($academicterm); ?></td>
                          </tr>
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0">
                        	...
                        	<?php 
							$sn=0;
							$sql=mysqli_query($con,"select * from bills where academicyear='$academicyear' and term='$academicterm' and feedescription='$fee'");
							while ($sqlrow=mysqli_fetch_array($sql)){
							
							$studentid=$sqlrow['studentid'];
							
								$query=mysqli_query($con,"select * from register where studentid='$studentid'");
