...
<html lang="en">
  <head>
    ...
    <title>Periodic Payment Report | SkoolMaster</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_documents_alt"></i> Periodic Payment Report</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_documents_alt"></i>Periodic Payment Report</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                      ...
                      <table width="650" border="0" align="center" style="color:#000;">
                          ...
                          <tr>
                            <td align="center" style="font-family:Tahoma; font-size:18px; text-align:center; font-weight:bold;color:#000;">PERIODIC PAYMENT REPORT AS AT <?php echo $_SESSION['startdate'] ?> TO <?php echo $_SESSION['enddate'] ?></td>
                          </tr>
                        ...
                        <?php
							...
							$query=mysqli_query($con,"SELECT * from payment where paymentdate between '$startdate' and '$enddate'");
							
							$sum_query=mysqli_query($con,"select sum(feeamount) as total from payment where paymentdate between '$startdate' and '$enddate'");
