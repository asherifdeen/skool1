...
<html lang="en">
  <head>
    ...
    <title>Transfer | SkoolMaster</title>
...
<script src="../resources/js/bootstrap.min.js"></script>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-reply"></i> Transfer</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="fa fa-reply"></i>Transfer</li>						  	
					</ol>
				</div>
			</div>
                         ...
                         <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <tbody>
                                    <?php
                                    $query=mysqli_query($con,"select * from transfer");
