...
<html lang="en">
  <head>
    ...
    <title>Staffs | SkoolMaster</title>
...
<script src="../resources/js/bootstrap.min.js"></script>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_genius"></i> Staffs</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_genius"></i>Staffs</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                         ...
                         <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" style="margin-bottom:20px;">
                                	<div class="col-md-12">
                                    <a href="staffregistration.php" class="btn btn-primary btn-sm"><i class="icon_plus_alt2"></i> Add New Staff</a>
                            	...
                            	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									echo 'No Staff has been registered!</div>';
									}
									...
									?>
                                        <tr>
                                            <td><a href='<?php echo "staffsubjectassigneddetials.php?staffid=$row[staffid]"; ?>' title="Click to view more details of <?php echo $row['lastname']." " .$row['firstname']; ?>"><?php echo $row['staffid']; ?></td>
                                            ...
                                            <td>
                                            <div class="btn-group">
                                                      <a class="btn btn-primary btn-sm" href='<?php echo "staffedit.php?staffid=$row[staffid]"; ?>' title="Click to make changes to <?php echo $row['surname']." " .$row['studentname']; ?>"><i class="icon_check_alt2"></i></a>
                                                      <a class="btn btn-danger btn-sm" href='<?php echo "registrationdelete.php?staffid=$row[staffid]"; ?>' onClick="return confirm('You are about deleting a Student.')" title="Click to remove <?php echo $row['lastname']." " .$row['firstname']; ?> from the system"><i class="icon_close_alt2"></i></a>
