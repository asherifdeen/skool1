...
$department=$_SESSION['trans_department'];
...
<html lang="en">
  <head>
    ...
    <title>Exams Report | SkoolMaster</title>
              ...
              <!-- page start-->
              		...
              		<div class="row">
                        ...
                        <?php      
							...
							$c=0;
							$getstids=mysqli_query($con,"select DISTINCT studentid from generalscore where academicyear='$academicyear' and class='$class' and term='$term'");

							if(mysqli_num_rows($getstids)<1){
							...
							while($foundstids=mysqli_fetch_array($getstids)){
							$c++;
							$studentidget[$c]=$foundstids['studentid'];
							
							$studentdetails=mysqli_query($con,"Select * from register where studentid='$studentidget[$c]'");
							
							$detailsrow=mysqli_fetch_array($studentdetails);
							$studentname=$detailsrow['surname'].' '.$detailsrow['studentname'];
							$studenthouse=$detailsrow['house'];
                      ...
                      <table width="650" border="0" align="center" style="color:#000;">
                        ...
                        <table width="780" border="0" style="margin-top:30px;color:#000; font-size:14px" align="center">
                        	<tr>
                        		...
                        		<td width="25%"><?php echo $studentidget[$c] ?></td>
                            ...
                            <tr>
                                ...
                                <td>
                                	<?php 
										$getavgscore=mysqli_query($con,"select averagescore from classaverage where studentid='$studentidget[$c]'");
                            ...
                            <tr>
                        		...
                        		<td>
                                	<?php 
										$getclasspos=mysqli_query($con,"select position from classposition where studentid='$studentidget[$c]'");
                        ...
                        <table width="780" border="1" style="margin-top:30px;color:#000;" align="center">
                           ...
                           <?php
								...
								$category=substr("$class",0,1);
								
								
 								$core=mysqli_query($con,"select subject,totalscore from generalscore where studentid='$studentidget[$c]' and academicyear='$academicyear' and class='$class' and term='$term' and category like'$category%' order by subject ASC");
                            ...
                            <tr align="center">
                            	...
                            	<td>
									<?php 
										$core40=mysqli_query($con,"select score from assessment where studentid='$studentidget[$c]' and academicyear='$academicyear' and class='$class' and term='$term' and subject='$corerows[subject]'");
                                ...
                                <td>
                                	<?php 
										$core60=mysqli_query($con,"select score from exams where studentid='$studentidget[$c]' and academicyear='$academicyear' and class='$class' and term='$term' and subject='$corerows[subject]'");
                                ...
                                <td><?php
										...
										$post=mysqli_query($con,"select position from subjectposition where studentid='$studentidget[$c]' and subject='$corerows[subject]'");
