...
<html lang="en">
  <head>
    ...
    <title>Term Setup | SkoolMaster</title>
		  ...
		  <div class="row">
				...
				<div class="col-lg-6">
                    ...
                    <div class="panel">
                        ...
                        <form class="form-horizontal" method="post" action="termonlysetupscript.php" enctype="multipart/form-data">
                        	...
                        	<div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <input class="form-control input-sm" id="academicyear" name="academicyear"  type="text" placeholder="Academic Year" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <input class="form-control input-sm" id="term" name="term"  type="text" placeholder="Term" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <input class="form-control input-sm" id="begindate" name="begindate"  type="text" placeholder="Begin Date" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <input class="form-control input-sm" id="enddate" name="enddate"  type="text" placeholder="End Date" required />
                                          </div>
                                      </div>
                                    ...
                                    <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <input class="form-control input-sm" id="nexttermbegin" name="nexttermbegin"  type="text" placeholder="Next Term Begin" required />
                                          </div>
                                      </div>
                    ...
                    <div class="alert alert-danger">
                      <strong>Please!</strong> Setup term before you can proceed. Thank You.
                   </div>
				</div>
			</div>
              <!-- page start-->
