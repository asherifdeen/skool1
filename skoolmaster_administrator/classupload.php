...
<html lang="en">
  <head>
    ...
    <title>Class Score Upload | SchoolMaster</title>
...
$(document).ready(function(){
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-upload"></i> Upload Class Assessment</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="fa fa-upload"></i>Upload Class Assessment</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                     		...
                     		<div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                          ...
                                          <form class="form-horizontal well" action="classimport.php" method="post" name="upload_excel" enctype="multipart/form-data">
                                                <fieldset>
