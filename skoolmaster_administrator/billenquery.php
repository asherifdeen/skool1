...
$staffnname=$_SESSION['staffname'];
 ...
 if(isset($_POST['submit'])){
	...
	$_SESSION['academicterm']=$_POST['academicterm'];
	...
	elseif(isset($_POST['individual']) && !empty($_POST['studentid'])){
		...
		header("Location: billsreportindividual.php");
		} 
...
<html lang="en">
  <head>
    ...
    <title> Print Bills | SkoolMaster</title>
...
$(document).ready(function(){
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-list"></i> Print Bills Enquiry</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="fa fa-list"></i>Print Bills Enquiry</li>						  	
					</ol>
				</div>
			</div>
                        ...
                        <div class="panel">
                            ...
                            <div class="row" style="margin-bottom:15px; margin-left:10px;"> 
 								<div class="form-group">
                                  <div class="col-lg-6">
                                      <button class="btn btn-primary btn-sm" type="submit" name="submit"><span class="icon_folder"></span> Print Bills</button>
                      ...
                      <section class="panel">
                          <header class="panel-heading tab-bg-primary ">
                              <ul class="nav nav-tabs">
                                  <li class="active">
                                      <a data-toggle="tab" href="#personal">Bill Detials</a>
                                  </li>
                                  <li class="">
                              ...
                              <div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-4">
                                              <select class="form-control input-sm" id="academicterm" name="academicterm"  required >
