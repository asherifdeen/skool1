...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_archive"></i> Fees</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_archive"></i>Fees</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                         ...
                         <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" style="margin-bottom:20px;">
                                	<div class="col-md-12">
                                    <a href="#myModal" role="button" data-toggle="modal" class="btn btn-primary btn-sm"><i class="icon_plus_alt2"></i> Add New Fees</a>
                            	...
                            	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                       <?php
										...
										echo 'No Fee has been added!</div>';
										}
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['feeduration']?></td>
                                            <td><?php echo $row['feeamount']?></td>
                                            <td>
                                            <div class="btn-group">
                                                      <a class="btn btn-primary btn-sm" href='<?php echo "feeedit.php?feeid=$row[feeid]"; ?>' title="Click to make changes to <?php echo $row['feedescription'] ?>"><i class="icon_check_alt2"></i></a>
                                                      <a class="btn btn-danger btn-sm" href='<?php echo "feedelete.php?feeid=$row[feeid]"; ?>' onClick="return confirm('You are about deleting a fee.')" title="Click to remove <?php echo $row['feedescription'] ?> from the system"><i class="icon_close_alt2"></i></a>
                                             </div>
   ...
   <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <form class="form-horizontal" role="form"  action="feeaddscript.php" method="post">
              <div class="modal-body">
                  ...
                  <div class="row" style="margin-top:5px;">
                      <div class="col-lg-3 control-label">Fee Description <span style="color:#F00;">*</span></div>
                      <div class="col-lg-6">
                          <input type="text" class="form-control input-sm" id="feedescription" placeholder="Fee Description"  name="feedescription">
                      </div>
                  </div> 
                        
                   <div class="row" style="margin-top:5px;">
                      <div class="col-lg-3 control-label">Duration</div>
                      <div class="col-lg-4">
                  ...
                  <div class="row" style="margin-top:5px;">
                      <div class="col-lg-3 control-label">Fee Amount <span style="color:#F00;">*</span></div>
                      <div class="col-lg-4">
                          <input type="text" class="form-control input-sm" id="feeamount" placeholder="Fee Amount" name="feeamount">
                      </div>
                  </div>     
               ...
               <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                  <button type="submit" class="btn btn-primary btn-sm" name="update">Save</button>
