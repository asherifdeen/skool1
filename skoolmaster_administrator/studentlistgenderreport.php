		  ...
		  <div class="row">
              ...
              <!-- page start-->
                      ...
                      <table width="650" border="0" align="center" style="color:#000;">
                          ...
                          <tr>
                            <td align="center" style="font-family:Tahoma; font-size:18px; text-align:center; font-weight:bold;color:#000;">STUDENTS LIST BY GENDER</td>
                          </tr>
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0">
                        	<?php 
								$gender=$_POST['gender'];
								$query=mysqli_query($con,"select * from register where gender='$gender'");
