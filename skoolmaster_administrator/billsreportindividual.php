              ...
              <!-- page start-->
              		...
              		<div class="row">
                        ...
                        <?php      
						   ...
						   $sql=mysqli_query($con,"select * from bills where term='$academicterm' and academicyear='$academicyear' and studentid='$studentid'");
                      ...
                      <table width="650" border="0" align="center" style="color:#000;">
                        ...
                        <table width="580" border="0" style="margin-top:30px;color:#000; font-size:14px" align="center">
                        	
                            <tr>
                            	<td width="" style="font-weight:bold">STUDENT NO.</td>
                        		<td width=""><?php echo $studentid ?></td>
                                
                                <td width="" style="font-weight:bold">CLASS</td>
                        		<td width=""><?php 
								
								$studentclass=mysqli_query($con,"select * from register where studentid='$studentid'");
                            ...
                            <tr>
								...
								$studentname=mysqli_query($con,"select * from register where studentid='$studentid'");
								...
								$billterm=mysqli_query($con,"select * from bills where term='$academicterm' and academicyear='$academicyear' and studentid='$studentid'");
                        ...
                        <table width="680" border="0" style="margin-top:30px;color:#000;" align="center">
                        ...
                        <table width="680" border="1" style="margin-top:10px;color:#000;" align="center">
							...
							$sn=1;
								...
								$sumbills=mysqli_query($con,"select Sum(feeamount) as total from bills where studentid='$studentid' and academicyear='$academicyear' and term='$academicterm'");
								
								$total=mysqli_fetch_array($sumbills);
								$totalbills=$total['total'];
								
								$fees=mysqli_query($con,"select * from bills where studentid='$studentid' and academicyear='$academicyear' and term='$academicterm'");
                        ...
                        <table width="600px" border="0" align="center" style="margin-top:50px; border-collapse:collapse;color:#000;">
                       ...
                       <table width="80%" border="0" align="center" style="margin-top:50px; border-collapse:collapse">
                          <tr style="text-align:center">
                              <td>
