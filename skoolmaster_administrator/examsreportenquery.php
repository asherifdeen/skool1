...
$staffnname=$_SESSION['staffname'];
 ...
 if(isset($_POST['submit'])){
	...
	$_SESSION['trans_academicyear']=$_POST['academicyear'];
	$_SESSION['trans_term']=$_POST['term'];
	$_SESSION['trans_class']=$_POST['class'];

	$_SESSION['trans_stid']=$_POST['studentid'];
	
	if (!isset($_POST['individual'])){ 
	
		 header("Location: examsreport.php");
	
	}
	elseif(isset($_POST['individual']) && empty($_POST['studentid'])){
		
		
		$_SESSION['result']="<div class='alert alert-danger'><strong>Sorry!</strong> Please student ID is required.</div>";
							//header("Location: examsreportenquery.php");
		
		}
	elseif(isset($_POST['individual']) && !empty($_POST['studentid'])){
		
		header("Location: examsreportindividual.php");
		} 
...
<html lang="en">
  <head>
    ...
    <title> Exams Report Enquiry | SkoolMaster</title>
...
$(document).ready(function(){
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_check"></i> Exams Report Enquiry</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Exams Report Enquiry</li>						  	
					</ol>
				</div>
			</div>
                        ...
                        <div class="panel">
                            ...
                            <div class="row" style="margin-bottom:15px; margin-left:10px;"> 
 								<div class="form-group">
                                  <div class="col-lg-6">
                                      <button class="btn btn-primary btn-sm" type="submit" name="submit"><span class="icon_folder"></span> View Report</button>
                      ...
                      <section class="panel">
                          <header class="panel-heading tab-bg-primary ">
                              <ul class="nav nav-tabs">
                                  ...
                                  <li class="">
                                      <a data-toggle="tab" href="#single">Single Student</a>
                                  </li>
                              </ul>
                          </header>
                          <div class="panel-body">
                              <div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-6">
                                              <input class="form-control input-sm" id="academicyear" name="academicyear"  type="text">
                                          </div>
                                      </div>
                                      
                                     
                                      <div class="row" style="margin-top:5px;">
                                      	<div class="col-lg-4 control-label">Academic Term <span style="color:#F00;">*</span></div>
                                        <div class="col-lg-4">
                                  ...
                                  <div id="single" class="tab-pane">
                                  	...
                                  	<div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-6">
                                              <input id="singlestudent" name="individual"  type="checkbox">
                                          </div>
                                      </div>
