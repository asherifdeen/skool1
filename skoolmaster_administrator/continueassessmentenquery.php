...
<html lang="en">
  <head>
    ...
    <title> Continue Ass Report Enquiry | SkoolMaster</title>
...
$(document).ready(function(){
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_check"></i>Continue Assessment Enquiry</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Continue Assessment Enquiry</li>						  	
					</ol>
				</div>
			</div>
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            <section class="panel-heading">
                               Student Assessment Enquiry
                            </section>
                            <div class="panel-body">
                            <form class="form-horizontal" method="post" action="continueassessmentreport.php" enctype="multipart/form-data">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-6">
                                              <select class="form-control input-sm" id="batch" name="batch"  required >
                                                    ...
                                                    <?php
													$sql=mysqli_query($con,"select distinct batch from register");
