...
<html lang="en">
  <head>
    ...
    <title> Exams Score Sheet | SkoolMaster</title>
...
$(document).ready(function(){
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_check"></i> Exams Score Sheet Enquiry</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Exams Score Sheet Enquiry</li>						  	
					</ol>
				</div>
			</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="examsscoresheetreport.php" enctype="multipart/form-data">
