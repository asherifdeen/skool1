...
$recieptnumber=$_SESSION['payrecieptnumber'];
$studentid=$_SESSION['paystudentid'];
$paymentamount=$_SESSION['paypaymentamount'];
$paymenttype=$_SESSION['paypaymenttype'];
$class=$_SESSION['payclass'];
$term=$_SESSION['payterm'];
