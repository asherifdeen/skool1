...
<html lang="en">
  <head>
    ...
    <title>Graduate List Report | SkoolMaster</title>
 ...
 <body>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-graduation-cap"></i> Graduate List Report</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="fa fa-graduation-cap"></i>Graduate List Report</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
              		...
              		<div class="row">
                    	<div class="col-lg-12">
						  ...
						  $query=mysqli_query($con,"select * from graduate where batch='$batch' ORDER BY studentid ASC");
							
							if(mysqli_num_rows($query)<1)
								{
								$_SESSION['result']="<div class='alert alert-info'><strong>Sorry!</strong>There is no match Batch.</div>";
					header("Location: graduatesenquery.php");
                      ...
                      <table width="650" border="0" align="center" style="color:#000;">
                          ...
                          <tr>
                            <td align="center" style="font-family:Tahoma; /* [disabled]font-size:18px; */ text-align:center; font-weight:bold; color:#000;">GRADUATES LIST REPORT</td>
                          </tr>
                        ...
                        <table width="780" border="1" style="margin-top:30px;color:#000;" align="center">
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $surname. " " .$studentname; ?></td>
