...
<html lang="en">
  <head>
    ...
    <title> Exams Score Edit | SkoolMaster</title>
...
<script src="../resources/js/bootstrap.min.js"></script>    
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="icon_check"></i> Exams Score Edit</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Exams Score Edit</li>						  	
					</ol>
				</div>
			</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel">
                            ...
                            <form class="form-horizontal" method="post" action="examsscoreupdatescript.php" enctype="multipart/form-data">
                            <div class="row" style="margin-bottom:15px; margin-left:10px;"> 
 								<div class="form-group">
                                  <div class="col-lg-6">
                                      <button class="btn btn-primary btn-sm" type="submit"><span class="icon_folder"></span> Update Score</button>
                              ...
                              <div class="tab-content">
                                  ...
                                  <div id="personal" class="tab-pane active">
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-6">
                                              <input class="form-control input-sm" id="academicyear" name="academicyear"  type="text" required>
                                          </div>
                                      </div>
                                      ...
                                      <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="col-lg-6">
                                              <input class="form-control input-sm" id="studentid" name="studentid"  type="text" required>
                                          </div>
                                      </div>
                                      
                                      <div class="row" style="margin-top:5px;">
                                      	<div class="col-lg-4 control-label">Exams Score<span style="color:#F00;">*</span></div>
                                        <div class="col-lg-6">
                                              <input class="form-control input-sm" id="score" name="score"  type="text" required>
                                          </div>
                                      </div>
