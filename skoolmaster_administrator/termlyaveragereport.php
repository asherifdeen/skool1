...
include("termlyaveragetransfer.php");
error_reporting(0);
session_start();
...
<html lang="en">
  <head>
    ...
    <title>Termly Average Report | SkoolMaster</title>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_documents_alt"></i>Termly Average Report</li>						  	
					</ol>
				</div>
			</div>
              <!-- page start-->
                      ...
                      <table width="650" border="0" align="center" style="color:#000;">
                          ...
                          <tr>
                            <td align="center" style="font-family:Tahoma; font-size:18px; text-align:center; font-weight:bold;color:#000;">STUDENTS TERMLY AVERAGE SCORE REPORT</td>
                          </tr>
                        ...
                        <table width="780" border="1" style="margin-top:30px;color:#000;" align="center">
                        	<tr>
                                ...
                                <td style="font-weight:bold" align="center">Student ID</td>
                                <td style="font-weight:bold" align="center">Student Name</td>
                                <td style="font-weight:bold" align="center">Average</td>
                                <td style="font-weight:bold" align="center">Position</td>
                            </tr>
                            <?php
							$sn=1;
							$query=mysqli_query($con,"select * from classaverage ORDER BY averagescore DESC");
                            ...
                            <tr>
                                ...
                                <td align="center">
                                	<?php
                                    $queryid=mysqli_query($con,"select surname,studentname from register where studentid='$id'");
									$studentname=mysqli_fetch_array($queryid);
									$firstname=$studentname['studentname'];
									$lastname=$studentname['surname'];
									
									echo $lastname. " " .$firstname;
									?>
                                </td>
                                <td align="center"><?php echo $row['averagescore'] ?></td>
                                <td align="center">
                                
                                <?php 
									$getclasspos=mysqli_query($con,"select position from classposition where studentid='$id'");
